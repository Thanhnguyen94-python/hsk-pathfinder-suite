...
export function HSK_HomeNoticeBoard() {
  return (
    <section id="notices" className="border-b border-border/60 bg-secondary/40 py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 overflow-x-auto">
          <div className="flex gap-4 min-w-max md:grid md:grid-cols-3 md:min-w-full">
            {notices.map((n) => (
              <article
                key={n.id}
                className="w-72 flex-shrink-0 md:w-auto md:flex-shrink flex flex-col rounded-xl border border-border bg-card p-6 shadow-sm transition-shadow hover:shadow-md"
              >
